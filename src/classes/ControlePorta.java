...
public class ControlePorta {
    ...
    /**
     * @param angulo - Valor a ser enviado pela porta serial
     * @param eixo - eixo a ser movido
     */
    public void enviaDados(int angulo, char eixo) {
        try {
            serialOut.write(eixo);
            serialOut.write(angulo);//escreve o valor na porta serial para ser enviado
